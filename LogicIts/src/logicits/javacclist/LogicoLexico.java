...
public class LogicoLexico/*@bgen(jjtree)*/implements LogicoLexicoTreeConstants, LogicoLexicoConstants {/*@bgen(jjtree)*/
  protected JJTLogicoLexicoState jjtree = new JJTLogicoLexicoState();public static void main(String[] args) throws ParseException{
  ...
  final public List<String> program() throws ParseException {/*@bgen(jjtree) program */
                          ASTprogram jjtn000 = new ASTprogram(JJTPROGRAM);
                          boolean jjtc000 = true;
                          jjtree.openNodeScope(jjtn000);List<String> listaDeTokens = new ArrayList<String>();
    try {
      Expressao(listaDeTokens);
      jj_consume_token(0);
jjtree.closeNodeScope(jjtn000, true);
                                   jjtc000 = false;
{if ("" != null) return listaDeTokens;}
...
if (jjtc000) {
  ...
  final public void Expressao(List<String> listaDeTokens) throws ParseException {
    Termo(listaDeTokens);
  ...
  final public void ComplementoDeExpressao(List<String> listaDeTokens) throws ParseException {
    Operador(listaDeTokens);
    Expressao(listaDeTokens);
  }

  final public void Termo(List<String> listaDeTokens) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NEGACAO:{
  ...
  final public void TermoSimples(List<String> listaDeTokens) throws ParseException {Token t1,t2;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case VARIAVEL:{
  ...
  final public void ExpEntreParent(List<String> listaDeTokens) throws ParseException {Token t1,t2;
...
listaDeTokens.add(t2.image);
  ...
  final public void VariavelSimples(List<String> listaDeTokens) throws ParseException {Token t1;
    t1 = jj_consume_token(VARIAVEL);
listaDeTokens.add(t1.image);
  }

  final public void Negacao(List<String> listaDeTokens) throws ParseException {Token t1;
    t1 = jj_consume_token(NEGACAO);
listaDeTokens.add(t1.image);
  }

  final public void Operador(List<String> listaDeTokens) throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case E:{
...
listaDeTokens.add(t.image);
  ...
  public LogicoLexicoTokenManager token_source;
