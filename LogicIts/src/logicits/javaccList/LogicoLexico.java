...
public class LogicoLexico/*@bgen(jjtree)*/implements LogicoLexicoTreeConstants, LogicoLexicoConstants {/*@bgen(jjtree)*/
  protected static JJTLogicoLexicoState jjtree = new JJTLogicoLexicoState();public static void main(String[] args) throws ParseException{
...
if (jjtc000) {
  ...
  static final public void Termo(List<String> listaDeTokens) throws ParseException {Token t1,t2;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NEGACAO:
    case VARIAVEL:{
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
listaDeTokens.add(t2.image);
  ...
  static final public void Operador(List<String> listaDeTokens) throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LOGO:{
